"""Script for launching Minecraft with the Fabric loader.

This script takes the Minecraft version and directory from the user and uses the
minecraft_launcher_lib library to launch Minecraft with the Fabric loader.

The script prompts the user for the Minecraft version and directory.

The script then generates a UUID and launches Minecraft with the Fabric loader
using the minecraft_launcher_lib library.
"""
